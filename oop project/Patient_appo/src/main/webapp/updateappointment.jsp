...
body{
background-image:url(docs/images/allback.jpg);
...
.container {
  border-radius: 5px;
  background: linear-gradient(to bottom left, #cc0099 0%, #000066 100%);
  padding: 20px;
  float: center;
  width: 70%;
  margin-top: 6px;
...
<form action="update" method="post">
 ...
 <a href="Apoointment.jsp" class="previous">&laquo; Previous</a>
</form>
 </div>
